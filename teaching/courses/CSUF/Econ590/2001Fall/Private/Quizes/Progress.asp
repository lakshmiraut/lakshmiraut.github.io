...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2001Fall_Econ590 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2001Fall_Econ590 WHERE StudentID = " & "'" & Session("UserID") &"'"
...
' *************************************HW1************************
      ...
      Response.Write("<TD>"&"<B> Empirical Project</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 15 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("HW1")  & "</TD></TR>")

' *************************************HW2************************
 
      Response.Write("<TD>"&"<B> Presentation</B>" & "</TD>")
