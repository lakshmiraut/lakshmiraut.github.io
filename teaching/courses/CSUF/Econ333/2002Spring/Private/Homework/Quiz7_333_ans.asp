...
total=0
 ...
 Response.Write("Answers to Hoework#7. If you have questions, please contact, Professor L.K. Raut at lraut@fullerton.edu </font> <BR><BR><BR>")
...
If request.QueryString("Q7_16")="a"  Then
 ...
 Response.Write("<TD>Q7_16.</TD><TD>" + request.QueryString("Q7_16")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
If request.QueryString("Q7_17")="b"  Then
 ...
 Response.Write("<TD>Q7_17.</TD><TD>" + request.QueryString("Q7_17")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
If request.QueryString("Q7_18")="c"  OR request.QueryString("Q7_18")=".6" Then
 ...
 Response.Write("<TD>Q7_18.</TD><TD>" + request.QueryString("Q7_18")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
If request.QueryString("Q7_19")="b"  Then
 ...
 Response.Write("<TD>Q7_19.</TD><TD>" + request.QueryString("Q7_19")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
If request.QueryString("Q7_20")="a"  Then
 ...
 Response.Write("<TD>Q7_20.</TD><TD>" + request.QueryString("Q7_20")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
If request.QueryString("Q7_21")="a"  Then
 ...
 Response.Write("<TD>Q7_21.</TD><TD>" + request.QueryString("Q7_21")+"</TD><TD>Wrong, Please try again.</TD>")
end if

Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_22")="b"  Then
 score=score+1
 Response.Write("<TD>Q7_22.</TD><TD>" + request.QueryString("Q7_22")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q7_22.</TD><TD>" + request.QueryString("Q7_22")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_23")="a"  Then
 score=score+1
 Response.Write("<TD>Q7_23.</TD><TD>" + request.QueryString("Q7_23")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q7_23.</TD><TD>" + request.QueryString("Q7_23")+"</TD><TD>Wrong, Please try again.</TD>")
end if
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_24")="a"  Then
 score=score+1
 Response.Write("<TD>Q7_24.</TD><TD>" + request.QueryString("Q7_24")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q7_24.</TD><TD>" + request.QueryString("Q7_24")+"</TD><TD>Wrong, Please try again.</TD>")
end if
