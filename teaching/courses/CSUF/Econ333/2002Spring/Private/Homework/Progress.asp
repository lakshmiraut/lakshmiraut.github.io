...
' *************************************HW8************************
      ...
      Response.Write("<TD>"&"<B> Homework # 8</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
...
' *************************************HW9************************
      ...
      Response.Write("<TD>"&"<B> Homework # 9</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("HW9")  & "</TD></TR>")


' *************************************HW10************************
 
      Response.Write("<TD>"&"<B> Homework # 10</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("HW10")  & "</TD></TR>")
