...
Conn.BeginTrans
QueryString= "SELECT * FROM 2003Fall_Econ333_06 WHERE StudentID= " & "'" & Request("StudentID") &"'"
RS.Open QueryString, Conn,3,3


  If Request("StudentID")="1234" Then
...
if RS.RecordCount <> 0 Then
   If RS("password")<> "" Then
      If  RS("password")= Request("password") Then
         Session("Status")="2003Fall_Econ333_06"
...
'  Response.Write("Your password being updated.") 
  ...
  End if
Else 
  %> Your student ID is not registered for this course.  Please Contact me, email at <a href="mailto:lraut@fullerton.edu" > lraut@fullerton.edu </a>
  <%
End if  
RS.Close
