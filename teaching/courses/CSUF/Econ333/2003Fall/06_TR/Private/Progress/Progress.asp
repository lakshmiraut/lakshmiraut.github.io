...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2003Fall_Econ333_06 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2003Fall_Econ333_06 WHERE StudentID = " & "'" & Session("UserID") &"'"
...
' *************************************Midterm 1************************
      ...
      Response.Write("<TD>"&"<B> Mid-term Exam # 1(scantron only)</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 90 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Exam_Mid1")  & "</TD></TR>")


' *************************************Midterm 1************************
 
      Response.Write("<TD>"&"<B> Mid-term Exam # 1(Essay)</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 10 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Exam_Mid1_essay")  & "</TD></TR>")



' *************************************Midterm 2************************
 
      Response.Write("<TD>"&"<B> (corrected score for Mid-term Exam # 2 </B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
