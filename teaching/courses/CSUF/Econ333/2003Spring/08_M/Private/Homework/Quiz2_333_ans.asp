...
Answers=Answers + ";Q2_7 = " + request.QueryString("Q2_7") 
...
Response.Write(Time())
 ...
 Response.Write(" Grading of your homework # 2. If you have questions, please contact, Professor L.K. Raut at lraut@fullerton.edu </font>  <BR><BR><BR>")
...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2003Spring_Econ333_08 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2003Spring_Econ333_08 WHERE StudentID = " & "'" & Session("UserID") &"'"
