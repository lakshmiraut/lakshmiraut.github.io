...
total=0
 ...
 Response.Write("Answers to Quiz5. If you have questions, please contact, Professor L.K. Raut at lraut@fullerton.edu </font> <BR><BR><BR>")
...
total=total+1
If request.QueryString("Q5_1")="d"  Then 
 score=score+1
 Response.Write("<TD>Q5_1.</TD><TD>" + request.QueryString("Q5_1")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_1.</TD><TD>" + request.QueryString("Q5_1")+"</TD><TD>Wrong, the correct answer is: d</TD>")
end if

Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_2")="b"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_4")="a"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_5")="d"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_7")="b"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_8")="d"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_10")="b"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_11")="c"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_12")="c"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_13")="d"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_14")="a"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_15")="b"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_16")="a"  Then
 score=score+1
 Response.Write("<TD>Q5_16.</TD><TD>" + request.QueryString("Q5_16")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_16.</TD><TD>" + request.QueryString("Q5_16")+"</TD><TD>Wrong, Please try again.</TD>")
end if


Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_17")="d"  Then
 score=score+1
 Response.Write("<TD>Q5_17.</TD><TD>" + request.QueryString("Q5_17")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_17.</TD><TD>" + request.QueryString("Q5_17")+"</TD><TD>Wrong, Please try again.</TD>")
end if


Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_18")="0.6"  OR request.QueryString("Q5_18")=".6" Then
 score=score+1
 Response.Write("<TD>Q5_18.</TD><TD>" + request.QueryString("Q5_18")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_18.</TD><TD>" + request.QueryString("Q5_18")+"</TD><TD>Wrong, Please try again.</TD>")
end if

Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_19")="a"  Then
 score=score+1
 Response.Write("<TD>Q5_19.</TD><TD>" + request.QueryString("Q5_19")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_19.</TD><TD>" + request.QueryString("Q5_19")+"</TD><TD>Wrong, Please try again.</TD>")
end if

Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q5_20")="c"  Then
 score=score+1
 Response.Write("<TD>Q5_20.</TD><TD>" + request.QueryString("Q5_20")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q5_20.</TD><TD>" + request.QueryString("Q5_20")+"</TD><TD>Wrong, Please try again.</TD>")
end if
