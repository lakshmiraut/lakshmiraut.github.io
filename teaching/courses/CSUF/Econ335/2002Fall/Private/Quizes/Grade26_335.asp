...
Answers=Answers + ";Q26_16 = " + request.QueryString("Q10_16") + ";Q26_17 = " + request.QueryString("Q10_17") + ";Q26_18 = " + request.QueryString("Q10_18")
Answers=Answers + ";Q26_19 = " + request.QueryString("Q10_19") + ";Q26_20 = " + request.QueryString("Q10_20") + ";Q26_21 = " + request.QueryString("Q10_21")
Answers=Answers + ";Q26_22 = " + request.QueryString("Q10_22") + ";Q26_23 = " + request.QueryString("Q10_23") + ";Q26_24 = " + request.QueryString("Q10_24")
Answers=Answers + ";Q26_25 = " + request.QueryString("Q10_25") 
...
total=total+1
If request.QueryString("Q10_16")="b"  Then 
 score=score+1
  Response.Write("<TD>Q26_16.</TD><TD>" + request.QueryString("Q10_16")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_16.</TD><TD>" + request.QueryString("Q10_16")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_17")="a"  Then 
 score=score+1
  Response.Write("<TD>Q26_17.</TD><TD>" + request.QueryString("Q10_17")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_17.</TD><TD>" + request.QueryString("Q10_17")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_18")="c"  Then 
 score=score+1
  Response.Write("<TD>Q26_18.</TD><TD>" + request.QueryString("Q10_18")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_18.</TD><TD>" + request.QueryString("Q10_18")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_19")="c"  Then 
 score=score+1
  Response.Write("<TD>Q26_19.</TD><TD>" + request.QueryString("Q10_19")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_19.</TD><TD>" + request.QueryString("Q10_19")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_20")="d"  Then 
 score=score+1
  Response.Write("<TD>Q26_20.</TD><TD>" + request.QueryString("Q10_20")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_20.</TD><TD>" + request.QueryString("Q10_20")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_21")="b"  Then 
 score=score+1
  Response.Write("<TD>Q26_21.</TD><TD>" + request.QueryString("Q10_21")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_21.</TD><TD>" + request.QueryString("Q10_21")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_22")="d"  Then 
 score=score+1
  Response.Write("<TD>Q26_22.</TD><TD>" + request.QueryString("Q10_22")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_22.</TD><TD>" + request.QueryString("Q10_22")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_23")="c"  Then 
 score=score+1
  Response.Write("<TD>Q26_23.</TD><TD>" + request.QueryString("Q10_23")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_23.</TD><TD>" + request.QueryString("Q10_23")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_24")="a"  Then 
 score=score+1
  Response.Write("<TD>Q26_24.</TD><TD>" + request.QueryString("Q10_24")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_24.</TD><TD>" + request.QueryString("Q10_24")+"</TD><TD>           </TD>")
end if
  Response.Write("</TR><TR>")
...
total=total+1
If request.QueryString("Q10_25")="c"  Then 
 score=score+1
  Response.Write("<TD>Q26_25.</TD><TD>" + request.QueryString("Q10_25")+"</TD><TD>    </TD>")
else
  Response.Write("<TD>Q26_25</TD><TD>" + request.QueryString("Q10_25")+"</TD><TD>           </TD>")
end if
