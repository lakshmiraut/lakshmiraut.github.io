...
Set recordCollection=objMyDatabase.Execute("SELECT*FROM 2004Summer_Econ335_01")
Dim cno
cno=0
...
Do While Not recordCollection.EOF
    ...
    Session("Status")="2004Summer_Econ335_01_valid_student"
...
If cno=1 Then 
 Session("Status")="2004Summer_Econ335_01"
