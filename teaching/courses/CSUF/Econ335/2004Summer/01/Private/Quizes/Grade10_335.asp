...
<BODY   TEXTFONT="Times New Roman" bgcolor="#008080" text="#FFFFFF"  >
...
Answers=Answers + ";Q10_13 = " + request.QueryString("Q10_13") + ";Q10_14 = " + request.QueryString("Q10_14") 
Answers=Answers + ";Q10_15 = " + request.QueryString("Q10_15") + ";Q10_16 = " + request.QueryString("Q10_16") + ";Q10_17 = " + request.QueryString("Q10_17")
Answers=Answers + ";Q10_18 = " + request.QueryString("Q10_18") + ";Q10_19 = " + request.QueryString("Q10_19") + ";Q10_20 = " + request.QueryString("Q10_20") 
...
If request.QueryString("Q10_7")="g"  Then
 score=score+1
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_8")="b"  Then
 score=score+1
...
If request.QueryString("Q10_11")="a"  Then
 score=score+1
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_12")="b"  Then
 score=score+1
...
If request.QueryString("Q10_14")="c"  Then
 score=score+1
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_15")="c"  Then
 score=score+1
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_16")="d"  Then
 score=score+1
  Response.Write("<TD>Q10_16.</TD><TD>" + request.QueryString("Q10_16")+"</TD><TD>  </TD>")
else
  Response.Write("<TD>Q10_16.</TD><TD>" + request.QueryString("Q10_16")+"</TD><TD>         </TD>")
end if
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_17")="d"  Then
 score=score+1
  Response.Write("<TD>Q10_17.</TD><TD>" + request.QueryString("Q10_17")+"</TD><TD>  </TD>")
else
  Response.Write("<TD>Q10_17.</TD><TD>" + request.QueryString("Q10_17")+"</TD><TD>         </TD>")
end if
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_18")="a"  Then
 score=score+1
  Response.Write("<TD>Q10_18.</TD><TD>" + request.QueryString("Q10_18")+"</TD><TD>  </TD>")
else
  Response.Write("<TD>Q10_18.</TD><TD>" + request.QueryString("Q10_18")+"</TD><TD>         </TD>")
end if
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_19")="d"  Then
 score=score+1
  Response.Write("<TD>Q10_19.</TD><TD>" + request.QueryString("Q10_19")+"</TD><TD>  </TD>")
else
  Response.Write("<TD>Q10_19.</TD><TD>" + request.QueryString("Q10_19")+"</TD><TD>         </TD>")
end if
  ...
  Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q10_20")="a"  Then
 score=score+1
  Response.Write("<TD>Q10_20.</TD><TD>" + request.QueryString("Q10_20")+"</TD><TD>  </TD>")
else
  Response.Write("<TD>Q10_20.</TD><TD>" + request.QueryString("Q10_20")+"</TD><TD>         </TD>")
end if
...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2004Summer_Econ335_01 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2004Summer_Econ335_01 WHERE StudentID = " & "'" & Session("UserID") &"'"
