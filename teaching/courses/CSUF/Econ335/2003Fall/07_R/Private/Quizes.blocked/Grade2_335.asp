...
total=total+1
If request.QueryString("Q2_1")="c"  Then 
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_3")="f"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_6")="a"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_7")="w"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_8")="w+x+y+z"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_9")="x+y+z"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_10")="u+z"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_11")="u"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_12")="z" OR request.QueryString("Q2_12")="-z"  OR request.QueryString("Q2_12")="- z"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_16")="s+t" OR request.QueryString("Q2_16")="-(s+t)"  OR request.QueryString("Q2_16")="- (s+t)" OR request.QueryString("Q2_16")="-s-t" Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_17")="r+s+t"  Then
 score=score+1
...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2003Fall_Econ335_07 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2003Fall_Econ335_07 WHERE StudentID = " & "'" & Session("UserID") &"'"
