...
SIZE="+1" FACE="Times New Roman">If you do not have a password yet, please click on the submit button to obtain your password. Otherwise, just type in your login id and password to obtain restricted material.</FONT></P>

<P>Student ID #  <INPUT TYPE= "txt" NAME="StudentID" MAXLENGTH="20" size="20"> (*Required
