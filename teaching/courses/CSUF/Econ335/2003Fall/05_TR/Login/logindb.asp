...
Set recordCollection=objMyDatabase.Execute("SELECT*FROM 2003Fall_Econ335_05")
Dim cno
cno=0
...
Do While Not recordCollection.EOF
    ...
    Session("Status")="2003Fall_Econ335_05_valid_student"
...
If cno=1 Then 
 Session("Status")="2003Fall_Econ335_05"
