...
Set recordCollection=objMyDatabase.Execute("SELECT*FROM 2001_Econ335")
Dim cno
cno=0
...
<font size='+2' face='Times'>1) 1) Please Contact me to get your password and
loginid.<br>
2) Back to 
