...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_23")="34.50"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_24")="55.50"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_27")="4.50"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_28")="4.50"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_29")="8.00"  Then
 score=score+1
 Response.Write("<TD>Q7_29.</TD><TD>" + request.QueryString("Q7_29")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q7_29.</TD><TD>" + request.QueryString("Q7_29")+"</TD><TD>Wrong. The correct answer is 8.00</TD>")
end if


Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_30")="8.00"  Then
 score=score+1
 Response.Write("<TD>Q7_30.</TD><TD>" + request.QueryString("Q7_30")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q7_30.</TD><TD>" + request.QueryString("Q7_30")+"</TD><TD>Wrong.  The correct answer is 8.00</TD>")
end if
