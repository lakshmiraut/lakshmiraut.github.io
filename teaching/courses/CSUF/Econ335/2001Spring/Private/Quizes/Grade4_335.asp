...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_16")="c"  Then
 score=score+1
 Response.Write("<TD>Q4_16.</TD><TD>" + request.QueryString("Q4_16")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q4_16.</TD><TD>" + request.QueryString("Q4_16")+"</TD><TD>Wrong, Please try again.</TD>")
end if


Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_17")="d"  Then
 score=score+1
 Response.Write("<TD>Q4_17.</TD><TD>" + request.QueryString("Q4_17")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q4_17.</TD><TD>" + request.QueryString("Q4_17")+"</TD><TD>Wrong, Please try again.</TD>")
end if


Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_18")="b"  Then
 score=score+1
 Response.Write("<TD>Q4_18.</TD><TD>" + request.QueryString("Q4_18")+"</TD><TD>Correct</TD>")
else
 Response.Write("<TD>Q4_18.</TD><TD>" + request.QueryString("Q4_18")+"</TD><TD>Wrong, Please try again.</TD>")
end if

Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_19")="F"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_20")="F"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_21")="F"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_22")="T"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_23")="T"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_24")="d"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q4_25")="b"  Then
 score=score+1
