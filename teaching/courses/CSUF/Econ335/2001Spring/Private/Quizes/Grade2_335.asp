...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_12")="z"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_16")="s+t"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_21")="21000"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_22")="11000"  Then
 score=score+1
...
Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q2_24")="3750"  Then
 score=score+1
