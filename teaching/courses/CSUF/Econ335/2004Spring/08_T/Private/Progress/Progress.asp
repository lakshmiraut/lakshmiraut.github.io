...
' *************************************Midterm 2************************
 ...
 ' *************************************Bonus Points************************
IF  RS("Bonus_Point_Mid1") > 0 Then
      Response.Write("<TD>"&"<B> Bonus points for Mid1</B>" & "</TD>")
      Response.Write("<TD>"&"<B> Congratualtions</B>" & "</TD>")
      Response.Write("<TD>"&   RS("Bonus_Point_Mid1")  & "</TD></TR>")
End if
      ' *************************************Project Group_NO ************************
 
      Response.Write("<TD>"&"<B> Project Group #</B>" & "</TD>")
      Response.Write("<TD>"&"<B> If blank, form your group </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Group_NO")  & "</TD></TR>")
...
' *************************************Paper************************
      ...
      Response.Write("<TD>"&"<B> out of 20 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Project_Score")  & "</TD></TR>")
