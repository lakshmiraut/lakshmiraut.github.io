...
Set recordCollection=objMyDatabase.Execute("SELECT*FROM 2002Spring_Econ335")
Dim cno
cno=0
...
Do While Not recordCollection.EOF
    ...
    Session("Status")="2002Spring_Econ335_valid_student"
...
If cno=1 Then 
 Session("Status")="2002Spring_Econ335"
