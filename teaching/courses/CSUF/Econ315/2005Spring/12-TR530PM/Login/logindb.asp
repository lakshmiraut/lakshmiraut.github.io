...
Set recordCollection=objMyDatabase.Execute("SELECT*FROM 2005Spring_Econ315_12")
Dim cno
cno=0
...
Do While Not recordCollection.EOF
    ...
    Session("Status")="2005Spring_Econ315_12_valid_student"
...
If cno=1 Then 
 Session("Status")="2005Spring_Econ315_12"
