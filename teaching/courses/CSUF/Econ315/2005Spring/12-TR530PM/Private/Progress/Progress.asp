...
' *************************************HW3************************
      ...
      Response.Write("<TD>"&"<B> Homework # 3<BR> 3.03 extra points added </B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
...
' *************************************Midterm 2 Bonus ************************
      ...
      Response.Write("<TD>"&"<B> Bonus Points for Mid-term Exam # 2</B>" & "</TD>")
      Response.Write("<TD>"&"<B> Add to your mid2 score </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Bonus_mid2")  & "</TD></TR>")
...
' *************************************Adjusted Mid2 Score ************************
      ...
      Response.Write("<TD>"&"<B> Bonus Points for Mid-term Exam # 2</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 100 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Adjusted_Mid2")  & "</TD></TR>")
...
' *************************************Roll-7 ************************
      ...
      Response.Write("<TD>"&"<B> Attendance 7</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 1 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Roll7")  & "</TD></TR>")
      

' *************************************Roll-8 ************************
 
      Response.Write("<TD>"&"<B> Attendance 8</B>" & "</TD>")
      Response.Write("<TD>"&"<B> 1 </B>" & "</TD>")
      Response.Write("<TD>"&   RS("Roll8")  & "</TD></TR>")
