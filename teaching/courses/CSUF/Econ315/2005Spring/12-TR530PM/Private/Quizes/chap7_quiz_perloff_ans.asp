...
Answers=Answers + ";Q7_22 = " + request.QueryString("Q7_22") + ";Q7_23 = " + request.QueryString("Q7_23") 
...
Response.Write(". <BR>")
 ...
 Response.Write("Answers to Homework #5. If you have questions, please contact, Professor L.K. Raut at lraut@fullerton.edu </font> <BR><BR><BR>")
...
If request.QueryString("Q7_2")="c"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_3")="b"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_4")="d"  Then
 score=score+1
...
If request.QueryString("Q7_7")="c"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_8")="d"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_9")="b"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_10")="a"  Then
 score=score+1
...
If request.QueryString("Q7_11")="a"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_12")="c"  Then
 score=score+1
...
If request.QueryString("Q7_13")="b"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_14")="c"  Then
 score=score+1
...
If request.QueryString("Q7_15")="a"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_16")="d"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_17")="c"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_18")="c"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_19")="c"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_20")="b"  Then
 score=score+1
...
If request.QueryString("Q7_22")="b"  Then
 score=score+1
   ...
   Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q7_23")="b"  Then
 score=score+1
