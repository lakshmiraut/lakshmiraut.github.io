...
Response.Write(". <BR>")
 ...
 Response.Write("Answers to Homework #2. If you have questions, please contact, Professor L.K. Raut at lraut@fullerton.edu </font> <BR><BR><BR>")
...
total=total+1
If request.QueryString("Q3_1")="a"  Then 
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_3")="d"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_4")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_5")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_8")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_9")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_10")="a"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_12")="d"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_13")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_14")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_17")="a"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_18")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_19")="d"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_21")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_22")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_24")="d"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_25")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_27")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_28")="a"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_29")="d"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_30")="c"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_32")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_34")="b"  Then
 score=score+1
...
' Response.Write("</TR><TR>")
total=total+1
If request.QueryString("Q3_35")="a"  Then
 score=score+1
...
Conn.BeginTrans
'     QueryString= "SELECT * FROM 2005Spring_Econ315_12 WHERE Name= " & "'" & Session("UserName") &"'"
QueryString= "SELECT * FROM 2005Spring_Econ315_12 WHERE StudentID = " & "'" & Session("UserID") &"'"
